    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Auto Countertop" size="md">
      <div className="space-y-4">
        <div className="text-xs text-slate-500">
          ...
          <strong className="text-slate-700">{selectedCount}</strong> selected
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 rounded-lg border border-slate-300/80 bg-white/70 text-sm text-slate-700"
            >
              {EDGE_PROFILES.map((p) => (
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-slate-300/80 bg-white/70 text-xs text-slate-700"
                />
              </div>
              <div>
                <label className="block text-xs text-slate-600 mb-1">
