  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-5 page-enter">
        ...
        <div className="flex items-start justify-between gap-3 flex-wrap">
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2 flex-wrap mb-2">
              ...
              <span className="text-xs font-mono text-fg-600 bg-surf-card px-1.5 py-0.5 rounded">
                {proposal.kind}
              </span>
              {category && (
                <span className="text-xs text-fg-600">
          ...
          <div className="flex items-center justify-between mb-3 gap-2 flex-wrap">
            ...
            <div className="inline-flex rounded-lg border border-border-soft overflow-hidden text-xs font-medium">
              <button
                ...
                className={`px-2.5 py-1 ${diffMode === 'line' ? 'bg-indigo-600 text-white' : 'text-fg-700 hover:bg-surf-muted'}`}
              >
                Line
              </button>
              <button
                ...
                className={`px-2.5 py-1 ${diffMode === 'word' ? 'bg-indigo-600 text-white' : 'text-fg-700 hover:bg-surf-muted'}`}
              >
                Word
              </button>
            </div>
      ...
      {proposal.proposed_structured_data && (
        <div className="glass-white rounded-2xl p-4 sm:p-5">
          <h3 className="text-sm font-semibold text-fg-900 mb-3 uppercase tracking-wide">Diff — structured data</h3>
          <KbDiffViewer
