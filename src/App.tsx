...
function App() {
  ...
  function renderPage() {
    switch (currentPage) {
      ...
      case 'prices':
        return <PriceList />;
      case 'projects':
        return <Projects selectedProjectId={selectedProjectId} onClearSelection={() => setSelectedProjectId(null)} onActiveTabChange={setActiveProjectTab} onProjectOpen={(id: string | null) => setOpenProjectId(id)} />;
      case 'settings':
        return <Settings />;
      default:
        return <Dashboard onNavigate={setCurrentPage} onNavigateToProject={handleNavigateToProject} />;
  ...
  return (
    <>
      ...
      <AiChat currentPage={currentPage} projectId={openProjectId} activeProjectTab={activeProjectTab} />
    </>
  );
}
