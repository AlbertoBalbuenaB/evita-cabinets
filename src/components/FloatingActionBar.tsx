...
export function FloatingActionBar({
  ...
  return (
    <>
      ...
      <div
        className="fixed top-[264px] lg:top-[168px] right-0 left-0 lg:left-[var(--rail-w)] z-[36] transition-[left,box-shadow] duration-[250ms] ease-[cubic-bezier(0.16,1,0.3,1)]"
        style={{
          boxShadow: scrolled
