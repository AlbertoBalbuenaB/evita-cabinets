  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-3 items-stretch">
      ...
      <div className={`rounded-lg border p-3 ${
        activeMethod === 'sqft' ? 'border-blue-300 bg-blue-50' : 'border-border-soft bg-surf-card'
      }`}>
        ...
        {hasOptimizer ? (
          <>
            <div className={`flex items-center gap-1 text-base font-bold tabular-nums ${
              ...
              deltaTone === 'red'   ? 'text-red-600'   : 'text-fg-500'
            }`}>
      ...
      {/* Breakdown side */}
      <div className={`rounded-lg border p-3 ${
        activeMethod === 'optimizer' ? 'border-blue-300 bg-blue-50' : 'border-border-soft bg-surf-card'
      }`}>
        <div className="flex items-center justify-between mb-1">
