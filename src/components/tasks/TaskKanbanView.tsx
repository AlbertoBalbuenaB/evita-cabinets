        ...
        return (
          ...
          >
            ...
            <div className="flex items-center gap-2 px-3 py-2.5 border-b border-white/60">
              ...
              <span className="text-xs font-semibold text-fg-600 uppercase tracking-wide flex-1">
                {cfg.label}
              </span>
              <span className="text-xs text-fg-400 font-medium bg-surf-card backdrop-blur-sm rounded-full w-5 h-5 flex items-center justify-center shadow-sm">
                {columnTasks.length}
              </span>
            </div>
            ...
            <div className="flex-1 px-2 pb-2 pt-2 space-y-2 min-h-[80px]">
              ...
              {columnTasks.length === 0 && !isDragTarget && (
                <div className="h-12 border-2 border-dashed border-white/80 rounded-lg flex items-center justify-center">
                  <span className="text-[10px] text-fg-300">Drop here</span>
                </div>
              )}
            </div>
          </div>
